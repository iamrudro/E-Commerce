...
import { removeErrors, removeSuccess, updateProfle } from '../features/user/userSlice';
...
function UpdateProfile() {
    ...
    useEffect(() => {
        if (user) {
            setName(user.name)
            setEmail(user.email)
            setAvatarPreview(user.avatar.url || './images/avatar.jpg')
        }
    }, [user])
